...
const viewInfo: Record<
  string,
  { title: string; subtitle: string; autoSave?: boolean }
> = {
  "/dashboard": {
    title: "Dashboard",
    subtitle: "Resumen operativo Orinoco Quality & Control",
  },
  "/calibration/new": {
    title: "Sesión de Calibración",
    subtitle: "Registro directo de lecturas y evaluación",
    autoSave: true,
  },
  "/instruments": {
    title: "Instrumentos",
    subtitle: "Inventario de equipos de medición",
  },
  "/standards": {
    title: "Patrones",
    subtitle: "Estándares de trazabilidad metrológica",
  },
  "/calibration": {
    title: "Centro de Aprobación",
    subtitle: "Gestión y emisión de certificados oficiales",
  },
  "/audit-log": {
    title: "Auditoria",
