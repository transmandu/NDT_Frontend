...
const INSTRUMENT_TYPES = [
  ...
  { code: 'ME-005', label: 'Balanza Analítica', prefix: 'BAL', icon: '', category: 'mass', unit: 'g', unitOptions: ['g', 'kg', 'mg'], color: '#10B981', description: 'Calibración gravimétrica con pesas patrón clase OIML', extras: [{ key: 'num_points', label: 'Puntos de calibración', type: 'number', hint: 'Cantidad de puntos (ej: 5)', placeholder: '5', min: 3, max: 10 }] },
  ...
  { code: 'ME-003', label: 'Manómetro de Presión', prefix: 'MAN', icon: '', category: 'pressure', unit: 'bar', unitOptions: ['bar', 'psi', 'kPa', 'MPa', 'Pa'], color: '#EF4444', description: 'Calibración por comparación con transductor de presión patrón', extras: [{ key: 'gauge_type', label: 'Tipo de manómetro', type: 'select', options: ['Analógico (bourdon)', 'Digital', 'Diferencial', 'Absoluto'], hint: 'Principio de operación' }] },
